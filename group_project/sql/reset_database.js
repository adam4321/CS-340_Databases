...
INSERT INTO Bugs (projectId, bugSummary, bugDescription, dateStarted, resolution, fixed, priority) VALUES
    ...
    ((SELECT projectId FROM Projects AS p15 WHERE projectName = 'Force CRM'), 'Errant percent in string', 'Unexplained percent symbol showing up in strings', '2004-03-01', '', 0, 3),
